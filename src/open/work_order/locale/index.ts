const i18n = {
  ...
  "zh-CN": {
    ...
    "workplace.content.work_order.cq": "客户质量服务工单",
    ...
    "workplace.content.work_order.quality": "质量品质工单",
    ...
    "workplace.add.custom.custom.name": "客户姓名",
    ...
    "workplace.add.custom.product.number.actual.error": "投产数量不能为空",
    "workplace.add.custom.product.number.defective.error": "不良品数量不能为空",
    "workplace.add.custom.product.date": "发生时间",
    "workplace.add.custom.product.date.error": "发生时间不能为空",

const i18n = {
  ...
  "zh-CN": {
    ...
    "workplace.step.label.context": "支持在模组的金属屏蔽盖上按照客户要求进行打印数据(如 二维码等",
    "workplace.step.mac": "定制流程概览",
    "workplace.step.mac.context": "提供定制MAC烧录服务, 可烧录客户MAC (乐鑫芯片一般自带MAC, 客户可以直接使用, 一般无需定制",
    "workplace.step.info": "定制流程概览",
    "workplace.step.info.context": "提供 一机一码 烧写服务, 可以有效烧写 Device ID/Key/License 等数据, 所有定制数据统一使用 MES 服务器管控, 生产过程中将定制内容和唯一的乐鑫芯片MAC进行绑定,确保烧录的唯一性",
    ...
    "workplace.table.info.title": "生产服务清单",
    "workplace.table.info.type": "服务类型",
    "workplace.table.info.sub.type": "服务子类型",
    "workplace.table.info.model": "模组产品类型",
    "workplace.table.info.chip": "芯片产品类型",
    "workplace.table.info.tip": "定制标签",
    "workplace.table.info.mac": "定制MAC地址",
    "workplace.table.info.firmware": "定制固件烧写",
    "workplace.table.info.context": "定制内容烧写",
    "workplace.table.info.pre.fit": "预配置服务",

const i18n = {
  ...
  "zh-CN": {
    ...
    "firmware.customization.info.encryption": "此次导入是否使用加密固件 ?",
    "firmware.customization.info.encryption.firmware": "加密固件",
    "firmware.customization.info.encryption.firmware.flash": "启用 Flash 加密 ?",
    "firmware.customization.info.encryption.firmware.secure.boot": "启用 Secure Boot ?",
    ...
    "firmware.information.key": "秘钥信息填写: ",
    "firmware.information.key.name": "秘钥名称",
    "firmware.information.key.name.error": "秘钥名称不能为空",
    "firmware.information.key.md5": "秘钥MD5",
    "firmware.information.key.md5.error": "秘钥MD5值不能为空",
    "firmware.information.key.file": "秘钥文件",
    "firmware.information.key.file.error": "秘钥文件不能为空",
    ...
    "firmware.pre.ca.setting.config.flashing.plan.info.1": "选择乐鑫烧录方案, 请确保在 ",
    "firmware.pre.ca.setting.config.flashing.plan.info.2": "定制服务选型",
    "firmware.pre.ca.setting.config.flashing.plan.info.3": " 已添加 定制固件服务",
    ...
    "firmware.customization.info.encryption.firmware.min_size": "固件信息条目字最少保留三条",
    ...
    "self.check.user": "客户校验",
    "self.check.esp": "乐鑫校验",
    "self.check.model": "模组厂校验",

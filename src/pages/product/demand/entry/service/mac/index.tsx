...
export default function CustomMac() {
  ...
  return (<DynamicOuterCard title={t['firmware.mac.title']} bodyStyle={bodyStyle}>
    <div className={style['context']}>
      <Alert className={style['context-text']} closable content={t['firmware.mac.partitions.write.area.efuse']}
    ...
    <Alert className={style['context-warn']} closable content={t['firmware.mac.partitions.warn']}
           style={{ maxWidth: '30rem', marginBottom: 20 }} closeElement='Close' />

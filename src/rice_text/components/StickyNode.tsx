...
import { $getNodeByKey, $setSelection, createEditor, DecoratorNode } from "lexical";
...
const useEspEffect: typeof useLayoutEffect = CAN_USE_DOM
  ? useLayoutEffect
  : useEffect;
    ...
    <div ref={stickyContainerRef} className="sticky-note-container">
      <div
        ...
        <LexicalNestedComposer
          ...
          initialTheme={{ paragraph: "StickyEditorTheme__paragraph" }}>
